...
$projects = [
    ...
    [
        ...
        'skills'       => ['PHP', 'phpMyAdmin', 'JavaScript'],
        'image'        => 'assets/knuffelgallerij.png',
        'tags'         => 'php phpmyadmin javascript',
        'link'         => 'https://knuffel-gallerij.infinityfreeapp.com/'
    ],
    [
        'project_id'   => 'notepad',
        'title'        => 'Notepad',
        'summary'      => 'A clean and minimal notepad web app built with HTML, CSS, and JavaScript.',
        'description'  => 'This simple browser-based notepad was created as a practice project to sharpen my skills in front-end development. It allows users to write and save text locally in their browser using localStorage, so content stays even after refreshing or closing the tab. I focused on keeping the design minimal and distraction-free, while also experimenting with features like auto-saving and character limits. This project gave me a better understanding of DOM manipulation, JavaScript event handling, and client-side storage. It was also a great opportunity to explore how even small utilities can benefit from thoughtful UX and subtle UI decisions.',
        'skills'       => ['JavaScript', 'CSS'],
        'image'        => 'assets/notepad.png',
        'tags'         => 'javascript css',
        'link'         => 'https://suzanneb836.github.io/Notepad/'
    ],
    [
        'project_id'   => 'iammirte',
        'title'        => 'iAmMirte',
        'summary'      => 'A full-stack prototype created for Stichting iAmMirte to promote educational robots and STEM workshops.',
        'description'  => 'This project was developed using HTML, CSS, JavaScript, and PHP, and gave me hands-on experience combining front-end and back-end techniques. The site includes a responsive webshop to showcase the MIRTE robot, a form for schools to request workshops, and clear sections explaining the foundation’s mission. I worked with semantic HTML, responsive layouts using Flexbox and Grid, and added interactivity with vanilla JavaScript. On the backend, I used PHP for form handling. While the site doesn’t include payment processing yet, the structure is ready for future integration. This project helped me deepen my understanding of full-stack development in a socially driven context.',
        'skills'       => ['PHP', 'CSS', 'JavaScript'],
        'image'        => 'assets/iammirte.png',
        'tags'         => 'php css javascript',
        'link'         => 'https://suzanneb836.github.io/iAmMirte/'
    ],
];
